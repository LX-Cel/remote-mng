...
日期：2026-09-13。对应实现与操作指南见 [distribution.md](distribution.md)。这些是本地构建、受控 loopback 测试结果；没有改变全局 rmg 安装或个人 Claude Skill，也没有发布 GitHub release。
...
最终源码另建以下两个本地制品，保留 `ready` 目录及其试验摘要不变：
